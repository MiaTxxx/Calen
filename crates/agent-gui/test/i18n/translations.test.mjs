...
test("translation lookup falls back to the key for unknown entries", () => {
  assert.equal(i18n.t("app.name", "en-US"), "Calen");
  assert.equal(i18n.t("settings.aboutTitle", "zh-CN"), "关于 Calen");
  assert.equal(i18n.t("settings.aboutTitle", "en-US"), "About Calen");
