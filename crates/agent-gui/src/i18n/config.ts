...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.clearContext": "清除当前上下文",
    "chat.clearContextConfirmTitle": "清除当前上下文？",
    "chat.clearContextConfirmDescription":
      "此前消息仍会保留在当前会话中，但不会再发送给模型，也不会保留旧摘要。",
    ...
    "chat.searchNoResults": "没有匹配的对话",
    "chat.searchTitleMatches": "标题匹配",
    "chat.searchContentMatches": "内容匹配",
    "chat.searchFailed": "搜索失败，请重试",
    "chat.previewRoleUser": "你",
    "chat.previewRoleAssistant": "助手",
    "chat.previewMessageCount": "{count} 条消息",
    ...
    "chat.exitConfirmTitle": "退出 Calen？",
    ...
    "chat.plan.badge": "规划模式",
    "chat.plan.badgeHint": "只读探索 · 确认后再实现",
    "chat.plan.approveExecute": "批准执行",
    "chat.plan.exit": "退出规划",
    "chat.plan.entered": "已进入规划模式：只读工具，写完方案后点「批准执行」或发送 /execute。",
    "chat.plan.exited": "已退出规划模式，可使用完整工具。",
    "chat.plan.alreadyOn": "当前会话已在规划模式。",
    "chat.plan.alreadyOff": "当前会话不在规划模式。",
    "chat.plan.inputHint": "规划模式：探索与写方案；/execute 或点「批准执行」开始实现…",
    ...
    "chat.draftAttachmentsMissing": "草稿中的 {count} 个附件已失效，已保留文字并移除附件引用。",
    ...
    "settings.aboutRestartingDesc": "Calen 正在退出并重新打开。",
    ...
    "settings.backgroundDesc": "选择一张本地图片作为主界面背景，可调整遮罩透明度与模糊度。",
    "settings.backgroundEnable": "启用自定义背景",
    "settings.backgroundPick": "选择图片",
    "settings.backgroundRemove": "移除",
    "settings.backgroundOpacity": "遮罩不透明度",
    "settings.backgroundBlur": "模糊度",
    ...
    "settings.saveDrafts": "保存未发送草稿",
    "settings.searchModels": "搜索模型",
    "settings.all": "全部",
    "settings.added": "已添加",
    "settings.notAdded": "未添加",
    "settings.newlyAdded": "新添加",
    "settings.maxOutputTokens": "最大输出",
    "settings.hideSuggestions": "本次不显示历史建议",
    "settings.manageProviderHistory": "管理历史记录",
    "settings.providerHistoryCount": "最近记录 {count} 条",
    "settings.restoreHiddenProviderHistory": "恢复已隐藏记录",
    "settings.clearProviderHistory": "清空当前供应商历史",
    "settings.restoreProviderHistoryItem": "恢复这条记录",
    "settings.hideProviderHistoryItem": "隐藏这条记录",
    "settings.saveDraftsDesc": "切换会话、页面或重启应用后恢复尚未发送的文字和附件引用。",
    "settings.chatLayout": "聊天布局",
    "settings.chatLayoutDesc": "回复与输入区共用内容宽度；桌面端也可直接拖动输入框边缘。",
    "settings.chatLayoutNarrow": "窄",
    "settings.chatLayoutStandard": "标准",
    "settings.chatLayoutWide": "宽",
    "settings.chatLayoutFull": "铺满",
    "settings.chatLayoutWidth": "内容宽度",
    "settings.chatLayoutHeight": "输入区高度",
    "settings.themeEditor": "主题编辑器",
    "settings.resetAll": "全部重置",
    "settings.localFontName": "本机字体名称",
    "settings.themeJson": "主题 JSON（版本 1）",
    "settings.export": "导出",
    "settings.import": "导入",
    ...
    "settings.defaultShellAuto": "自动",
    "settings.defaultShellAutoDesc": "优先 PowerShell（pwsh → powershell → cmd）",
    "settings.defaultShellBash": "Bash",
    "settings.defaultShellBashDesc": "优先 Git Bash / bash.exe，不可用时回退 PowerShell",
    "settings.defaultShellPowerShell": "PowerShell",
    "settings.defaultShellPowerShellDesc": "仅使用 PowerShell 链（pwsh → powershell → cmd）",
    ...
    "settings.systemToolsBuiltinDesc": "Calen 在 Agent 模式下自动注册的内置工具，此处仅供查阅。",
    ...
    "settings.conversationTitleEnabled": "AI 自动标题",
    ...
    "settings.cronSchedule": "执行计划",
    "settings.cronScheduleHint": "选择固定间隔，或使用高级 cron 表达式",
    "settings.cronScheduleInterval": "固定间隔",
    "settings.cronScheduleIntervalHint": "每 N 分钟 / 小时 / 天",
    "settings.cronScheduleAdvanced": "高级 Cron",
    "settings.cronIntervalEvery": "每",
    "settings.cronIntervalUnitMinutes": "分钟",
    "settings.cronIntervalUnitHours": "小时",
    "settings.cronIntervalUnitDays": "天",
    "settings.cronIntervalPreview": "生成表达式",
    "settings.cronIntervalInvalid": "间隔必须是大于等于 1 的整数",
    ...
    "settings.remoteDesc": "通过云端 Gateway 远程控制本地 Calen",
    ...
    "settings.skillsImportDesc":
      "扫描本机 Claude Code、Codex、CodeBuddy 的技能目录，勾选后导入到 Calen。",
  ...
  "en-US": {
    ...
    "chat.clearContext": "Clear current context",
    "chat.clearContextConfirmTitle": "Clear the current context?",
    "chat.clearContextConfirmDescription":
      "Earlier messages remain visible in this conversation, but they will no longer be sent to the model and no previous summary will be retained.",
    ...
    "chat.searchTitleMatches": "Title matches",
    "chat.searchContentMatches": "Content matches",
    "chat.searchFailed": "Search failed, please retry",
    "chat.previewRoleUser": "You",
    "chat.previewRoleAssistant": "Assistant",
    "chat.previewMessageCount": "{count} messages",
    ...
    "chat.exitConfirmTitle": "Exit Calen?",
    ...
    "chat.plan.badgeHint": "Read-only exploration · implement after approval",
    "chat.plan.approveExecute": "Approve & execute",
    "chat.plan.exit": "Exit plan",
    "chat.plan.entered":
      "Plan mode on: read-only tools. Approve with the button or send /execute when ready.",
    "chat.plan.exited": "Plan mode off. Full tools are available.",
    "chat.plan.alreadyOn": "This conversation is already in plan mode.",
    "chat.plan.alreadyOff": "This conversation is not in plan mode.",
    "chat.plan.inputHint": "Plan mode: explore and write a plan; /execute or Approve to implement…",
    ...
    "chat.draftAttachmentsMissing":
      "{count} draft attachments are no longer available. Text was kept and their references were removed.",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "About Calen",
    ...
    "settings.aboutRestartingDesc": "Calen is quitting and opening again.",
    ...
    "settings.backgroundDesc":
      "Pick a local image as the main interface background, with adjustable overlay opacity and blur.",
    "settings.backgroundEnable": "Enable custom background",
    "settings.backgroundPick": "Choose image",
    "settings.backgroundRemove": "Remove",
    "settings.backgroundOpacity": "Overlay opacity",
    ...
    "settings.saveDrafts": "Save unsent drafts",
    "settings.searchModels": "Search models",
    "settings.all": "All",
    "settings.added": "Added",
    "settings.notAdded": "Not added",
    "settings.newlyAdded": "New",
    "settings.maxOutputTokens": "Max output",
    "settings.hideSuggestions": "Hide history suggestions for now",
    "settings.manageProviderHistory": "Manage recent entries",
    "settings.providerHistoryCount": "{count} recent entries",
    "settings.restoreHiddenProviderHistory": "Restore hidden entries",
    "settings.clearProviderHistory": "Clear history for this provider type",
    "settings.restoreProviderHistoryItem": "Restore this entry",
    "settings.hideProviderHistoryItem": "Hide this entry",
    "settings.saveDraftsDesc":
      "Restore unsent text and attachment references after switching conversations, pages, or restarting the app.",
    "settings.chatLayout": "Chat layout",
    "settings.chatLayoutDesc":
      "Replies and composer share one width. On desktop, drag the composer edges to resize.",
    "settings.chatLayoutNarrow": "Narrow",
    "settings.chatLayoutStandard": "Standard",
    "settings.chatLayoutWide": "Wide",
    "settings.chatLayoutFull": "Full",
    "settings.chatLayoutWidth": "Content width",
    "settings.chatLayoutHeight": "Composer height",
    "settings.themeEditor": "Theme editor",
    "settings.resetAll": "Reset all",
    "settings.localFontName": "Local font name",
    "settings.themeJson": "Theme JSON (version 1)",
    ...
    "settings.defaultShellAuto": "Auto",
    "settings.defaultShellAutoDesc": "Prefer PowerShell (pwsh → powershell → cmd)",
    "settings.defaultShellBash": "Bash",
    "settings.defaultShellBashDesc":
      "Prefer Git Bash / bash.exe; fall back to PowerShell if missing",
    "settings.defaultShellPowerShell": "PowerShell",
    "settings.defaultShellPowerShellDesc": "PowerShell chain only (pwsh → powershell → cmd)",
    ...
    "quickAsk.openMain": "Open main window",
    "quickAsk.close": "Close",
    "quickAsk.send": "Send",
    "quickAsk.stop": "Stop",
    ...
    "settings.systemToolsBuiltinDesc":
      "Built-in tools that Calen registers automatically in Agent mode. Read-only list; click the eye icon for details.",
    "settings.systemToolsCustomDesc":
    ...
    "settings.conversationTitleEnabled": "AI-generated titles",
    ...
    "settings.cronSchedule": "Schedule",
    "settings.cronScheduleHint": "Pick a fixed interval, or use an advanced cron expression",
    "settings.cronScheduleInterval": "Fixed Interval",
    "settings.cronScheduleIntervalHint": "Every N minutes / hours / days",
    "settings.cronScheduleAdvanced": "Advanced Cron",
    "settings.cronIntervalEvery": "Every",
    "settings.cronIntervalUnitMinutes": "minutes",
    "settings.cronIntervalUnitHours": "hours",
    "settings.cronIntervalUnitDays": "days",
    "settings.cronIntervalPreview": "Generated expression",
    "settings.cronIntervalInvalid": "Interval must be an integer >= 1",
    ...
    "settings.remoteDesc": "Control your local Calen remotely via cloud Gateway",
    ...
    "settings.skillsImportDesc":
      "Scan local Claude Code, Codex, and CodeBuddy skill directories, then pick skills to import into Calen.",
