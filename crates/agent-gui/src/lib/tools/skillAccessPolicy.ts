...
export function buildSkillAccessDeniedMessage(params: {
  ...
  return [
    ...
    "Do not bypass this with Bash, absolute paths, find /, or ~/.calen/skills (or legacy ~/.liveagent/skills).",
  ].join(" ");
}
  ...
  if (baseDir && isAlwaysEnabledSkillName(baseDir)) {
    throw new Error(
      [
        ...
        "Built-in Skills may be read and used, but their files are managed by Calen.",
