...
export async function buildBuiltinToolRegistry(
  ...
  return createBuiltinToolRegistry([
    ...
    createSubagentTools({
      ...
      customProviders: subagentRuntime.customProviders,
      subagentDefaultModel: subagentRuntime.subagentDefaultModel,
      parentSelectedModel: subagentRuntime.parentSelectedModel,
