...
export const ORGANIZER_SYSTEM_PROMPT = `# Calen Memory Organizer

You are running an offline memory organization pass for Calen.
...
export const TOPIC_CLUSTER_SYSTEM_PROMPT = `You are grouping existing Calen memories for an offline organization pass.
