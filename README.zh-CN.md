...
安装包由 GitHub Actions 自动构建、签名并发布,请前往 [**GitHub Releases**](https://github.com/MiaTxxx/Calen/releases/latest) 获取最新版本。
...
从 [Releases](https://github.com/MiaTxxx/Calen/releases/latest) 下载对应芯片的 DMG,打开后将 Calen 拖入「应用程序」:

- Apple Silicon(M 系列):`Calen-<版本>-macOS-aarch64.dmg`
- Intel:`Calen-<版本>-macOS-x64.dmg`
...
| 便携版 | `Calen-<版本>-Windows-x64-portable.zip` | 免安装,解压即用 |

### Linux 用户

从 [Releases](https://github.com/MiaTxxx/Calen/releases/latest) 按发行版选择:

| 格式 | 适用发行版 | 安装方式 |
|---|---|---|
| AppImage | 任意发行版 | `chmod +x` 后直接运行 |
| DEB | Debian / Ubuntu 系 | `sudo dpkg -i Calen-<版本>-Linux-x86_64.deb` |
| RPM | Fedora / openSUSE 系 | `sudo rpm -i Calen-<版本>-Linux-x86_64.rpm` |
